...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(u2,null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WAITTING_PAYMENT);
        Order o3 = new Order(u1,null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WAITTING_PAYMENT);
